      ...
      <main>
        ...
        <section id="therapies" className="min-h-screen px-10 py-20 lg:px-48 bg-gradient-to-b from-sky-100 to-sky-200 md:flex md:items-center">
          <div className="flex flex-col items-center gap-10 text-justify indent-7">
            ...
            <p className="text-4xl text-center font-cursive indent-0">Se você estiver atravessando uma fase difícil na vida, não hesite em buscar pela ajuda de um terapeuta. A psicoterapia pode salvar e transformar vidas.</p>
