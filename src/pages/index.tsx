          ...
          <div className="flex flex-col items-center gap-10 text-justify indent-7">
            ...
            <Link href={"/terapias/tcc"}>
              <div className="border-2 border-sky-700 hover:border-sky-50 bg-transparent hover:bg-sky-600 text-xl text-sky-700 hover:text-sky-50 rounded-xl p-3 transition ease-linear duration-100 hover:-translate-y-1 hover:scale-110">
                <h2 className="text-2xl text-center mb-2 indent-0">TERAPIA COGNITVO COMPORTAMENTAL</h2>
            ...
            <h3 className="text-2xl text-center uppercase indent-0">Beneficios</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 items-center gap-4">
              <div className="h-44 col-span-2 flex gap-2 border-2 border-sky-700 rounded-xl p-3 transition ease-linear">
                <div>
              ...
              <div className="h-44 lg:col-start-2 col-span-2 flex gap-2 border-2 border-sky-700 rounded-xl p-3 transition ease-linear">
                <div>
              ...
              <div className="h-44 md:col-start-2 lg:col-start-auto col-span-2 flex gap-2 border-2 border-sky-700 rounded-xl p-3 transition ease-linear">
                <div>
            ...
            <p className="text-xl font-bold">se você estiver atravessando uma fase difícil na vida, não hesite em buscar pela ajuda de um terapeuta. A psicoterapia pode salvar e transformar vidas.</p>
